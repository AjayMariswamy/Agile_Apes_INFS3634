...
public class QuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tiQuizAnswer = findViewById(R.id.tiQuizAnswer);
...
//        tvQuizScore.setText(getIntent().getStringExtra("Score"));
    ...
    public void setTvQuizQuestion() {
        ...
        tvQuizScore.setText("Bananas : " + bananas);
    }


    public void checkAnswer() {
        String answer = tiQuizAnswer.getText().toString().trim();
